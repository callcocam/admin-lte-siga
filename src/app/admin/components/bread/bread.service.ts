...
export class BreadService {
    breadcrumbChanged = new EventEmitter<Bread[]>(false);

    private breadcrumbs = new Array<Bread>();
    ...
    private createBreadcrumb(route: ActivatedRouteSnapshot, url: string): Bread {
        return {
