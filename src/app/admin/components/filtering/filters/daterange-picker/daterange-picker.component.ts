import { Directive, OnInit, AfterViewInit, Input, Output, EventEmitter, OnDestroy, DoCheck, ElementRef, KeyValueDiffers } from '@angular/core';
import { DaterangePickerService } from './daterange-picker.service';
...
export class DaterangePickerComponent implements AfterViewInit, OnDestroy, DoCheck {
  ...
  constructor(
      ...
      private config: DaterangePickerService,
